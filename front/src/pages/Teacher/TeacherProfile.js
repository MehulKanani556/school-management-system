    ...
    <div className="max-w-6xl mx-auto space-y-12">
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div className="flex items-center gap-8">
            <div className="relative group">
                <div className="w-32 h-32 rounded-[2.5rem] bg-slate-800 border-4 border-slate-900 shadow-2xl overflow-hidden relative">
                    {photoPreview ? (
                ...
                <label className="absolute -bottom-2 -right-2 w-10 h-10 bg-brand-primary hover:bg-blue-600 rounded-2xl flex items-center justify-center cursor-pointer shadow-xl border-4 border-brand-background transition-all hover:scale-110 z-10">
        ...
        <button onClick={() => setModalType('password')} className="flex items-center gap-3 px-8 py-4 bg-slate-900 border border-slate-800 rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] text-slate-400 hover:text-white hover:border-brand-primary/40 transition-all shadow-2xl group">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        <div className="lg:col-span-2 space-y-8">
            <form onSubmit={handleUpdate} className="bg-slate-900/40 border border-slate-800/80 rounded-[3rem] p-10 shadow-2xl space-y-10 backdrop-blur-sm">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-3">
                        ...
                        <input 
                            ...
                            className="w-full bg-slate-800/50 border border-slate-700/50 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-brand-primary/50 transition-all font-medium"
                        />
                    </div>
                    <div className="space-y-3">
                ...
                <div className="space-y-3">
                    ...
                    <textarea 
                        ...
                        className="w-full bg-slate-800/50 border border-slate-700/50 rounded-[1.5rem] px-6 py-4 text-white focus:outline-none focus:border-brand-primary/50 transition-all font-medium resize-none"
                    />
                </div>

                <button type="submit" className="w-full py-5 bg-brand-primary hover:bg-blue-600 rounded-2xl font-black text-xs uppercase tracking-[0.4em] text-white transition-all shadow-2xl active:scale-95 flex items-center justify-center gap-3">
        ...
        <div className="space-y-8">
            <div className="bg-gradient-to-br from-slate-900 via-slate-900 to-brand-primary/10 border border-slate-800/80 rounded-[3rem] p-10 shadow-2xl relative overflow-hidden group">
                ...
                <div className="space-y-8">
                    <div className="flex items-center gap-6">
                        <div className="w-12 h-12 rounded-2xl bg-slate-800 flex items-center justify-center text-brand-primary shadow-lg border border-slate-700">
                            <Mail size={18} />
                        </div>
                        <div>
                    ...
                    <div className="flex items-center gap-6">
                        <div className="w-12 h-12 rounded-2xl bg-slate-800 flex items-center justify-center text-luxury-emerald shadow-lg border border-slate-700">
                            <Calendar size={18} />
                        </div>
                        <div>
                    ...
                    <div className="flex items-center gap-6">
                        <div className="w-12 h-12 rounded-2xl bg-slate-800 flex items-center justify-center text-brand-secondary shadow-lg border border-slate-700">
                            <ShieldCheck size={18} />
                        </div>
                        <div>
                ...
                <div className="mt-12 pt-10 border-t border-slate-800">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {Array.isArray(profile?.qualifications) && profile.qualifications.map(q => (
                            <span key={q} className="bg-slate-800 px-3 py-1.5 rounded-lg text-[9px] font-black text-brand-primary uppercase tracking-widest border border-slate-700/50">
                                {q}
                            </span>
                        ))}
                    </div>
        ...
        <form onSubmit={handleChangePassword} className="space-y-6">
            <div className="space-y-3">
                ...
                <input 
                    ...
                    className="w-full bg-slate-800 border border-slate-700 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-brand-primary/50 transition-all"
                />
            </div>
            <div className="space-y-3">
            ...
            <button type="submit" className="w-full py-5 bg-slate-900 border border-slate-800 hover:border-brand-primary/40 rounded-2xl font-black text-xs uppercase tracking-[0.4em] text-white transition-all shadow-2xl active:scale-95">
