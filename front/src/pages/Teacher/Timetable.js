            ...
            <div className="no-print space-y-8">
                <header className="flex flex-col md:flex-row md:items-end justify-between gap-10 bg-slate-900/40 p-10 rounded-md border border-slate-800/60 shadow-2xl backdrop-blur-xl group">
                    ...
                    <div className="flex items-center gap-6">
                        <button
                            ...
                            className="group flex items-center gap-4 bg-slate-900 border border-slate-800 hover:border-brand-primary/40 text-slate-400 hover:text-brand-primary px-8 h-16 rounded-md font-black tracking-[0.3em] uppercase text-[11px] transition-all active:scale-95 font-outfit italic"
                        >
                        ...
                        <div className="relative group">
                            ...
                            <select
                                ...
                                className="bg-slate-950/80 border border-slate-800 h-14 pl-14 pr-10 rounded-md text-[11px] font-black uppercase tracking-widest outline-none focus:border-brand-primary transition-all text-white appearance-none cursor-pointer hover:bg-black font-outfit shadow-inner"
                            >
                ...
                {selectedClass ? (
                    <div className="space-y-10">
                        <div className="bg-black/40 p-2.5 rounded-md border border-slate-800/80 shadow-2xl overflow-x-auto no-scrollbar backdrop-blur-md self-start inline-flex">
                            {days.map(day => (
                                <button
                                    key={day}
                                    onClick={() => setActiveDay(day)}
                                    className={`px-10 py-4 rounded-md text-[10px] font-black uppercase tracking-widest transition-all duration-500 whitespace-nowrap ${activeDay === day
                        ...
                        <div className="bg-slate-950/40 border border-slate-800/60 rounded-md p-12 shadow-2xl relative overflow-hidden backdrop-blur-2xl">
                            ...
                            <div className="space-y-8 relative z-10">
                                <div className="flex items-center justify-between px-4 mb-2">
                                    ...
                                    <div className="px-5 py-2 bg-slate-900/80 rounded-md border border-slate-800 flex items-center gap-3">
                                        <div className="w-2 h-2 rounded-md bg-brand-primary animate-pulse shadow-glow"></div>
                                ...
                                <AnimatePresence mode="wait">
                                    {dailySchedule.length > 0 ? (
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                            {dailySchedule.map((slot, idx) => (
                                                <motion.div
                                                    ...
                                                    className="flex flex-col gap-8 p-10 bg-slate-900/40 border border-slate-800/50 rounded-md group hover:border-brand-primary/40 transition-all duration-700 hover:shadow-2xl cursor-default overflow-hidden relative"
                                                >
                                                    ...
                                                    <div className="flex items-center gap-4 pt-4 border-t border-slate-800/40 border-dashed">
                                                        <div className="flex items-center gap-3 bg-slate-950/80 px-4 py-2 rounded-md border border-slate-800 shadow-xl">
                                        ...
                                        <motion.div
                                            initial={{ opacity: 0 }}
                                            animate={{ opacity: 1 }}
                                            className="py-48 text-center bg-slate-900/10 rounded-md border-2 border-dashed border-slate-800/40"
                                        >
                    ...
                    <div className="py-60 flex flex-col items-center justify-center border-2 border-dashed border-slate-800/40 rounded-md bg-slate-900/20 backdrop-blur-sm group hover:border-brand-primary/10 transition-all duration-1000">
                        ...
                        <p className="text-slate-800 text-[11px] mt-4 font-bold tracking-[0.2em] uppercase italic bg-slate-900/40 px-6 py-2 rounded-md border border-slate-800/50">Select an academic sector to access institutional chronology</p>
                    </div>
                )}
            </div>
