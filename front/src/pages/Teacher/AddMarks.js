                                            ...
                                            >
                                                    ...
                                                    <div className="flex justify-center">
                                                        <div className="relative w-32 group-hover:scale-105 transition-transform duration-500">
                                                            <input 
                                                                ...
                                                                className="w-full bg-slate-900/60 border border-slate-800 h-14 px-6 rounded-md text-center text-base font-black text-white outline-none focus:border-brand-primary focus:bg-slate-900 transition-all italic font-outfit shadow-lg placeholder:text-slate-800"
                                                            />
                                                            <div className="absolute -bottom-2 -right-2 w-6 h-6 bg-slate-900 border border-slate-800 rounded-md flex items-center justify-center">
                                                ...
                                                <td className="px-12 py-7">
                                                    <input 
                                                        ...
                                                        className="w-full bg-slate-900/40 border border-slate-800/50 h-14 px-8 rounded-md text-[12px] font-medium text-slate-300 outline-none focus:border-brand-primary focus:bg-slate-900/80 transition-all font-outfit italic tracking-wide shadow-lg placeholder:text-slate-800"
                                                    />
                                                </td>
                                            </motion.tr>
                                        ))}
