    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-2">
                ...
                <div className="px-5 py-3 rounded-md bg-luxury-emerald/10 border border-luxury-emerald/20 flex items-center gap-4 shadow-2xl group cursor-default transition-all hover:shadow-luxury-emerald/10">
                    <div className="w-10 h-10 rounded-md bg-luxury-emerald flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-500">
                        <TrendingUp size={20} />
                    </div>
                    <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                {/* Cumulative Metric */}
                <div className="bg-brand-surface p-8 rounded-md border border-brand-border shadow-2xl relative overflow-hidden group">
                ...
                {/* Performance Feed */}
                <div className="md:col-span-1 xl:col-span-2 bg-brand-surface p-8 rounded-md border border-brand-border shadow-2xl overflow-hidden group">
                    <div className="flex justify-between items-start mb-8">
                        ...
                        <div className="p-3 rounded-md bg-brand-background text-slate-400 group-hover:text-brand-primary transition-all border border-brand-border">
                            <Activity size={20} />
                        </div>
                    </div>
                                    ...
                                    <tr key={i} className="group/row hover:bg-brand-background/40 transition-colors">
                                        <td className="py-4">
                                            <div className="flex items-center gap-4">
                                                <div className="w-10 h-10 rounded-md bg-brand-background border border-brand-border flex items-center justify-center text-slate-400 group-hover/row:border-brand-primary/40 transition-colors">
                                        ...
                                        <td className="py-4 text-right">
                                            <div className="flex flex-col items-end gap-0.5">
                                                ...
                                                <div className="flex items-center gap-1">
                                                    <div className="w-1 h-1 rounded-md bg-luxury-emerald animate-pulse"></div>
            ...
            <div className="bg-brand-surface border border-brand-border border-dashed rounded-md p-12 flex flex-col items-center justify-center text-center group hover:bg-brand-primary/5 transition-all">
                <div className="w-16 h-16 rounded-md bg-brand-background flex items-center justify-center mb-6 border border-brand-border group-hover:border-brand-accent transition-all duration-500 shadow-2xl">
                ...
                <div className="mt-8 px-6 py-2.5 rounded-md bg-brand-primary/10 border border-brand-primary/20 text-[10px] font-black uppercase text-brand-primary tracking-widest italic shadow-xl group-hover:bg-brand-primary group-hover:text-white transition-all cursor-pointer">
                    Initiate Node Sync
                </div>
            </div>
        </motion.div>
