    ...
    if (loading && !profile) {
        return (
            <div className="min-h-[400px] flex items-center justify-center">
                <div className="w-12 h-12 border-4 border-luxury-emerald/20 border-t-luxury-emerald rounded-full animate-spin"></div>
            </div>
        );
    }
        ...
        >
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <div className="xl:col-span-1 space-y-6">
                    <div className="bg-[#0f0f12] border border-slate-800/60 p-10 rounded-[3rem] relative overflow-hidden group">
                        <div className="absolute top-0 right-0 w-32 h-32 bg-luxury-emerald/5 rounded-full blur-3xl -mr-10 -mt-10"></div>
                        
                        <div className="relative z-10 text-center">
                            <div className="w-32 h-32 mx-auto rounded-[2.5rem] bg-slate-800 p-1 relative mb-6">
                                {profile?.photo ? (
                                    <img src={profile.photo} alt="Avatar" className="w-full h-full object-cover rounded-[2.2rem]" />
                                ) : (
                                    <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-slate-800 to-slate-900 rounded-[2.2rem]">
                                        <User size={48} className="text-slate-600" />
                                    </div>
                                )}
                                <div className="absolute -bottom-2 -right-2 bg-luxury-emerald p-2 rounded-xl shadow-lg border-2 border-[#0f0f12]">
                            ...
                            <div className="inline-flex items-center gap-2 bg-slate-800/40 px-4 py-2 rounded-xl border border-slate-700/50">
                    ...
                    <div className="bg-gradient-to-br from-[#0f0f12] to-luxury-emerald/5 border border-slate-800/60 p-8 rounded-[2.5rem]">
                ...
                <div className="xl:col-span-2 space-y-8">
                    <div className="bg-[#0f0f12] border border-slate-800/60 p-10 rounded-[3rem] shadow-2xl">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-4 text-white">
                                    <div className="p-3 bg-slate-800/40 rounded-xl"><Calendar size={20} className="text-brand-primary/70" /></div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-4 text-white">
                                    <div className="p-3 bg-slate-800/40 rounded-xl"><User size={20} className="text-luxury-emerald/70" /></div>
                            ...
                            <div className="space-y-2 md:col-span-2">
                                ...
                                <div className="flex items-center gap-4 text-white">
                                    <div className="p-3 bg-slate-800/40 rounded-xl"><MapPin size={20} className="text-brand-secondary/70" /></div>
                    ...
                    <div className="bg-[#0f0f12] border border-slate-800/60 p-10 rounded-[3rem] shadow-2xl relative overflow-hidden">
                        <div className="absolute bottom-0 right-0 w-48 h-48 bg-brand-primary/5 rounded-full blur-3xl -mr-20 -mb-20"></div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-4 text-white">
                                    <div className="p-3 bg-slate-800/40 rounded-xl"><ShieldCheck size={20} className="text-brand-primary/70" /></div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-4 text-white">
                                    <div className="p-3 bg-slate-800/40 rounded-xl"><Phone size={20} className="text-luxury-emerald/70" /></div>
