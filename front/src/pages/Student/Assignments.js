                ...
                {assignments.length > 0 ? (
                    assignments.map((assignment, idx) => (
                        <motion.div 
                            ...
                            className="bg-[#0f0f12] border border-slate-800/60 p-10 rounded-md shadow-2xl group hover:border-luxury-emerald/30 transition-all relative overflow-hidden"
                        >
                            ...
                            <div className="relative z-10 flex flex-col h-full">
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <div className={`w-2 h-2 rounded-md ${new Date(assignment.dueDate) < new Date() ? 'bg-luxury-rose' : 'bg-luxury-emerald'}`}></div>
                                </div>
                                ...
                                <div className="mt-10 flex gap-4">
                                    {assignment.fileUrl ? (
                                        <a 
                                            ...
                                            className="flex-1 py-4 bg-luxury-emerald hover:bg-emerald-500 text-black rounded-md flex items-center justify-center gap-3 text-[10px] font-black uppercase tracking-[0.2em] transition-all shadow-[0_0_20px_rgba(16,185,129,0.2)]"
                                        >
                                            Infiltrate File <Download size={14} />
                                        </a>
                                    ) : (
                                        <button className="flex-1 py-4 bg-slate-800 cursor-not-allowed text-slate-500 rounded-md flex items-center justify-center gap-3 text-[10px] font-black uppercase tracking-[0.2em]">
                                            No Asset <FileText size={14} />
                                        </button>
                                    )}
                                    <button className="p-4 bg-transparent border border-slate-800 hover:border-slate-600 rounded-md text-slate-500 transition-all">
