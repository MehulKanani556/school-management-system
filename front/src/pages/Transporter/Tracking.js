...
import { fetchVehicles } from '../../redux/slice/transport.slice';
import { 
                        ...
                        <div className="p-8 space-y-8">
                            ...
                            <div className="space-y-4 pt-4 border-t border-white/5">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-[10px] font-black text-slate-400 italic">GPS ACCURACY</span>
                                    </div>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-[10px] font-black text-slate-400 italic">SOCKET LINK</span>
                                    </div>
                                    <span className={`text-[10px] font-black ${isConnected ? 'text-emerald-500' : 'text-red-500'} italic uppercase`}>
                            ...
                            {isTracking ? (
                                <button 
                                    ...
                                    className="w-full py-4 bg-red-600/10 border border-red-600/30 text-red-500 text-[10px] font-black uppercase tracking-[0.2em] italic rounded hover:bg-red-600 hover:text-white transition-all flex items-center justify-center gap-2"
                                >
                                ...
                                <button 
                                    ...
                                    className="w-full py-4 bg-orange-600/10 border border-orange-600/30 text-orange-500 text-[10px] font-black uppercase tracking-[0.2em] italic rounded hover:bg-orange-600 hover:text-white transition-all flex items-center justify-center gap-2"
                                >
                                    <Navigation size={14} /> ESTABLISH COM-LINK
                                </button>
                            )}
                        </div>
                    </motion.div>
                ...
                <div className="absolute bottom-8 right-8 z-[1001] hidden xl:block">
                    <div className="bg-neutral-950/80 backdrop-blur-xl border border-white/5 p-6 rounded shadow-2xl w-96 space-y-4 overflow-hidden">
                        <div className="flex items-center justify-between border-b border-white/5 pb-3">
                            ...
                            <div className={`w-2 h-2 rounded-full ${isConnected ? 'bg-emerald-500 shadow-[0_0_10px_#10b981]' : 'bg-red-500 shadow-[0_0_10px_#ef4444]'}`}></div>
                        </div>
