    ...
    return (
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="space-y-8 pb-10 font-outfit">
            <div className="flex justify-between items-end px-2">
                <div>
                    <h1 className="text-3xl font-black italic uppercase tracking-tighter mb-1 leading-none text-rose-500">Core Identity</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 space-y-8">
                    <div className="bg-neutral-900 border border-slate-800/60 rounded-md p-10 shadow-2xl relative overflow-hidden group">
                        <div className="absolute top-0 right-0 w-32 h-32 bg-rose-600/10 rounded-full -mr-16 -mt-16 blur-3xl group-hover:bg-rose-600/20 transition-all duration-700"></div>
                        
                        <div className="flex flex-col items-center text-center relative z-10">
                            <div className="relative mb-6">
                                <div className="w-28 h-28 rounded-md bg-neutral-950 border border-slate-800 flex items-center justify-center text-rose-500 group-hover:border-rose-600/40 transition-all duration-500 overflow-hidden">
                                    {profileData.preview ? (
                                ...
                                <label className="absolute -bottom-2 -right-2 p-2 bg-rose-600 text-white rounded-md shadow-lg shadow-rose-600/20 hover:bg-rose-700 transition-all cursor-pointer">
                                    <Camera size={14} />
                            ...
                            <p className="text-[10px] font-black text-rose-500 uppercase tracking-[0.2em] italic mb-6">{user.role?.replace('_', ' ')}</p>
                        ...
                        <div className="mt-10 space-y-4 relative z-10">
                            <div className="flex items-center gap-4 text-slate-400 group/item">
                                <div className="w-8 h-8 rounded-md bg-neutral-950 border border-slate-800 flex items-center justify-center text-slate-700 group-hover/item:text-rose-500 transition-all"><Mail size={14} /></div>
                                <span className="text-[11px] font-black italic tracking-tighter uppercase truncate">{user.email}</span>
                            </div>
                            <div className="flex items-center gap-4 text-slate-400 group/item">
                                <div className="w-8 h-8 rounded-md bg-neutral-950 border border-slate-800 flex items-center justify-center text-slate-700 group-hover/item:text-rose-500 transition-all"><Shield size={14} /></div>
                    ...
                    <button 
                        ...
                        className="w-full py-4 border border-rose-600/30 text-rose-500 bg-rose-600/5 rounded-md text-[10px] font-black uppercase tracking-widest italic hover:bg-rose-600 hover:text-white transition-all shadow-xl shadow-rose-600/10 flex items-center justify-center gap-3"
                    >
                    ...
                    <div className="bg-neutral-900 border border-slate-800/60 rounded-md shadow-2xl overflow-hidden">
                        ...
                        <div className="p-8 space-y-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-2">
                                    ...
                                    <input 
                                        ...
                                        className="w-full bg-neutral-950 border border-slate-800/60 rounded-md py-3 px-4 text-xs font-bold text-slate-200 focus:outline-none focus:border-rose-600/50 transition-all italic leading-none uppercase" 
                                    />
                                </div>
                                <div className="space-y-2">
                            ...
                            <div className="space-y-6">
                                <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-rose-500 italic opacity-80 flex items-center gap-2 mb-4">
                                    ...
                                    {Object.entries(notifications).map(([key, value]) => (
                                        <div key={key} className="flex items-center justify-between p-4 bg-neutral-950/60 border border-slate-800/40 rounded-md">
                                            ...
                                            <button 
                                                ...
                                                className={`w-10 h-5 rounded-full relative transition-all duration-300 ${value ? 'bg-rose-600' : 'bg-slate-800'}`}
                                            >
                            ...
                            <div className="flex justify-end pt-4">
                                <button 
                                    type="submit"
                                    disabled={loading}
                                    className="px-8 py-4 bg-rose-600 text-white text-[11px] font-black italic uppercase tracking-widest rounded-md shadow-lg shadow-rose-600/20 hover:shadow-rose-600/40 hover:translate-y-[-2px] transition-all flex items-center gap-2 group leading-none disabled:opacity-50"
                                >
