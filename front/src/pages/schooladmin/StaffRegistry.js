...
import { fetchUsers, addStaff, clearUserMessage, clearUserError } from '../../redux/slice/user.slice';
                        ...
                        <div className="flex-1 space-y-5 relative z-10">
                            <div className="flex justify-between items-start">
                                <div>
                                    ...
                                    <span className={`text-[9px] font-black uppercase tracking-[0.2em] italic px-3 py-1 rounded-md border ${
                                        member.role === 'Accountant' ? 'border-luxury-gold/20 text-luxury-gold bg-luxury-gold/5' : 
                                ...
                                <div className="flex gap-2">
                                    <button className="p-2.5 bg-slate-950 border border-brand-border/40 rounded-md text-slate-600 hover:text-white transition-all"><Edit3 size={14} /></button>
                                    <button className="p-2.5 bg-slate-950 border border-brand-border/40 rounded-md text-slate-600 hover:text-luxury-rose transition-all"><Trash2 size={14} /></button>
                                </div>
                            </div>
