...
const Reports = () => {
    ...
    useEffect(() => {
        dispatch(fetchSchoolPerformance());
        dispatch(fetchFeeReport());
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    <h1 className="text-3xl font-black font-outfit tracking-tight text-white uppercase italic">
                        Institutional <span className="text-brand-primary">Intelligence</span>
                    </h1>
                    <p className="text-slate-500 text-xs font-black uppercase tracking-[0.3em] mt-1">High-Fidelity Operations & Academic Reporting</p>
                </div>
            ...
            {!loading && activeTab === 'performance' && schoolPerformance && (
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        {[
                            { label: 'Global Pass Rate', val: `${schoolPerformance.passRate}%`, icon: TrendingUp, color: 'text-emerald-400', trend: '+2.4%', up: true },
                            { label: 'Institutional Avg', val: `${schoolPerformance.overallAverage}%`, icon: GraduationCap, color: 'text-brand-primary', trend: '+1.1%', up: true },
                ...
                >
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="bg-brand-primary/10 border border-brand-primary/20 rounded-md p-8 flex flex-col justify-center text-center relative overflow-hidden group">
                            ...
                            <p className="text-[11px] font-black uppercase tracking-[0.3em] text-brand-primary mb-2">Total Projected Capital</p>
                            <h2 className="text-5xl font-black text-white font-outfit">₹{feeReport.totalExpected.toLocaleString()}</h2>
                            <p className="text-[10px] text-slate-500 font-black uppercase tracking-widest mt-4">Fiscal Year 2025-26</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-slate-900/40 border border-white/5 rounded-md p-10 flex flex-col md:flex-row items-center gap-12">
                        <div className="flex-1">
                            ...
                            <p className="text-slate-500 text-xs mt-2 leading-relaxed max-w-lg">
                                Generate high-fidelity attendance reports for compliance archival. Select specific parameters to export raw student presence data into high-portability formats suitable for physical auditing.
                            </p>
                        </div>
